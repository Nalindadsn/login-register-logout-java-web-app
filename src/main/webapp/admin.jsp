...
<span class="badge badge-success bg-success" > <%= session.getAttribute("role") %></span></h4>
			<h1 class="masthead-heading text-uppercase mb-0 shadow" style="color:#333">E- Government Document Management System</h1>
			<!-- Icon Divider-->
